...
import com.siddworks.android.crashed.BuildConfig;
...
public class AppHelper {
    ...
    private static List<AppsModel> model;
    ...
    public static void setModel(List<AppsModel> model) {
        AppHelper.model = model;
    }

    public static List<AppsModel> getModel() {
        return model;
    }
}
