package com.siddworks.android.crashed.ui.loader;
...
import com.siddworks.android.crashed.AppController;
import com.siddworks.android.crashed.model.AppsModel;
import com.siddworks.android.crashed.receiver.ApplicationsReceiver;
...
public class AppsLoader extends AsyncTaskLoader<List<AppsModel>> {
    ...
    public List<AppsModel> loadInBackground() {
        ...
        if(AppHelper.getModel() != null && AppHelper.getModel().size() > 0) {
            entries.addAll(AppHelper.getModel());
            return entries;
        }
        try {
