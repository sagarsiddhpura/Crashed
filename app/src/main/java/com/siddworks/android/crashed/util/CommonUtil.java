...
public class CommonUtil {
	...
	public static final String DATA_TYPE_SIGNED_INT = "SignedInteger";
    public static final String DATA_TYPE_SIGNED_FLOAT = "SingedFloat";
    public static final String DATA_TYPE_UNSIGNED_INT = "UnsignedInt";
    public static final String DATA_TYPE_UNSIGNED_FLOAT = "UnsignedFloat";
...
//		System.out.println("showAlertWithOneButton heading:"+heading+", message:"+message);
	...
	public static void setEditTextInputType(EditText edittext, String dataType) {
		if (edittext != null && !TextUtils.isEmpty(dataType)) {
            if(dataType.equals(DATA_TYPE_SIGNED_INT)) {
                edittext.setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_SIGNED );
            } else if(dataType.equals(DATA_TYPE_SIGNED_FLOAT)) {
                edittext.setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_SIGNED | InputType.TYPE_NUMBER_FLAG_DECIMAL );
            } else if(dataType.equals(DATA_TYPE_UNSIGNED_INT)) {
                edittext.setInputType(InputType.TYPE_CLASS_NUMBER );
            } else if(dataType.equals(DATA_TYPE_UNSIGNED_FLOAT)) {
